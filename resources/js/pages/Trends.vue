              ...
              <div :class="changeCardClass(insight)" class="rounded-lg p-4">
                ...
                <div class="flex items-center gap-1">
                  ...
                  <p class="text-2xl font-bold">
                    {{ Math.abs(insight.abs_change).toFixed(1) }}{{ insight.unit ?? '' }}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div v-if="expandedId === insight.key" class="mt-4 pt-4 border-t border-indigo-200 space-y-3">
                ...
                <div class="bg-white p-3 rounded border border-indigo-200">
                  ...
                  <p class="text-sm text-gray-700">
                    ...
                    {{ !isNaN(Math.abs(Number(insight.abs_change))) ? Math.abs(Number(insight.abs_change)).toFixed(1) : '-' }}{{ insight.unit ?? '' }} over the selected time period.
                  </p>
                </div>
              </div>
            </div>
